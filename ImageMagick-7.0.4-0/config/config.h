...
#define LIBRARY_PATH "/usr/local/lib/ImageMagick-7.0.4/"

/* Subdirectory of lib where ImageMagick architecture dependent files are
   installed. */
#define LIBRARY_RELATIVE_PATH "ImageMagick-7.0.4"
...
#define PACKAGE_STRING "ImageMagick 7.0.4-0"
...
#define PACKAGE_VERSION "7.0.4-0"
